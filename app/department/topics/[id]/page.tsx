...
const STATUS_COLORS: Record<string, string> = {
  ...
  TOPIC_PENDING: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400',
  APPROVED_1: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400',
  APPROVED_2: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-400',
  IN_PROGRESS: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400',
  TOPIC_COMPLETED: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400',
...
export default function TopicDetailPage() {
  ...
  const handleStudentClick = (student: any, studentCode: string) => {
    const studentData = {
      ...
      email: student?.email || '',
      phone: '',
      username: student?.username || studentCode,
      gender: 'male',
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                            ...
                            {enr.gradeReview && (
                              <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded border border-gray-200 dark:border-gray-600">
                                ...
                                <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                                  {enr.gradeReview.reviewGrade !== null ? enr.gradeReview.reviewGrade : '--'}
                                </p>
                              </div>
                            )}
                          </div>
