...
export default function TopicDetailPage() {
  ...
  const handleStudentClick = (student: any, studentCode: string) => {
    router.push(
      `/department/students/${studentCode}?backUrl=/department/topics/${topicId}`
    );
  };

  const handleTeacherClick = (teacher: any) => {
    router.push(
      `/department/teachers/${teacher.id}?backUrl=/department/topics/${topicId}`
    );
  };
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <button
                        onClick={() =>
                          router.push(
                            `/department/councils/${tc.councilCode}?backUrl=/department/topics/${topicId}`
                          )
                        }
                        className="cursor-pointer hover:text-blue-800 text-sm text-blue-600 dark:text-blue-400 mt-1"
                      >
                      ...
                      {tc.enrollments.map((enr: any) => (
                        ...
                        >
                          ...
                          <div className="mb-3">
                            <button
                              onClick={() =>
                                handleStudentClick(enr.student, enr.studentCode)
                              }
                            ...
                            {enr.final && (
                              <>
                                <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded border border-gray-200 dark:border-gray-600">
                                  ...
                                  <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                                    {enr.final.supervisorGrade !== null
                                      ? enr.final.supervisorGrade
                                      : "--"}
                                  </p>
                                </div>

                                <div className="p-3 bg-gray-50 dark:bg-gray-700 rounded border border-green-300 dark:border-green-700 bg-green-50 dark:bg-green-900/20">
                                  <div className="flex items-center gap-2 mb-1">
                                          ...
                                          <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {gd.defence?.teacher ? (
                                              <button
                                                ...
                                                className="cursor-pointer text-sm font-semibold text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                              >
            ...
            <div className="space-y-2">
              {topic.files.map((file: any) => (
                ...
                >
                  ...
                  <button
                    onClick={() => handleDownloadFile(file.id, topic.semesterCode, file.title)}
                    className="cursor-pointer px-3 py-1 text-sm bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors"
                  >
                    Tải xuống
                  </button>
                </div>
