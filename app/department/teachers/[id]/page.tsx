...
const ROLE_COLORS: Record<string, string> = {
  ...
  DEPARTMENT_LECTURER: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300',
...
export default function TeacherDetailPage() {
  ...
  useEffect(() => {
    ...
    const storedData = sessionStorage.getItem('teacherDetailData')
    if (storedData) {
      ...
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Vui lòng quay lại và chọn giảng viên để xem chi tiết
          </p>
          <button
    ...
    <div className="h-full overflow-y-auto">
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          <button
            onClick={() => router.push(teacher.backUrl || '/department/teachers')}
                    ...
                    <div className="flex items-center gap-3">
                      <span
                        className={`px-3 py-1 text-sm font-medium rounded-full ${
                          ROLE_COLORS[role.role] || 'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300'
                        }`}
                      >
                        {role.title}
                      </span>
