...
const ROLE_NAVIGATION: Record<RoleType, NavigationItem[]> = {
  TEACHER: [
    { label: "Gửi đề tài", href: "/teacher/submit-topic", icon: Send },
    { label: "Đề tài hướng dẫn", href: "/teacher/topics", icon: BookOpen },
    {
      label: "Hội đồng chấm điểm",
      href: "/teacher/councils",
      icon: ClipboardCheck,
    },
              ...
              <div className="flex items-center gap-3">
                <div
                  className={`p-2 rounded-lg ${
                    isExpanded ? colors.active : "bg-white dark:bg-gray-800"
                  }`}
                >
